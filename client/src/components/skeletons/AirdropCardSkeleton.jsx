...
const AirdropCardSkeleton = () => {
  return (
    <div className="h-full overflow-hidden rounded-lg bg-[var(--macos-card-bg)] shadow-sm ring-1 ring-[var(--macos-card-border)] motion-safe:animate-pulse" aria-hidden="true">
      {/* Image placeholder */}
      ...
      <div className="p-4">
        ...
        <div className="h-6 bg-slate-200 dark:bg-slate-700 rounded-full w-24 mb-4"></div>
